...
##### 补充内容：参与公共的PR仓库来完成第一次PR尝试

当然，如果您不想注册两个Github账户亦或由于某些原因对此感到比较麻烦的话

您也可以按照上面的说明来选择参与到Github上的一些公共且活跃维护的PR尝试仓库

比如说 [这个](https://github.com/ituring/first-pr) （不过第一次提交时您只能作为提交者进行尝试）

当您的PR被通过合并后，您的账户通常也会得到管理员权限，在此时您也可以来尝试作为管理员的身份来合并其他人的提交
