...
|尝试参与开源-可以用哪些方式参与开源|  需补充“参与 Gitee 流程”的内容或相关链接方便大家查看。 |  [立即修订](./第三部分——尝试参与开源/可以用哪些方式参与开源.md.) |
...
|启动自己的开源项目-开源许可证的应用| （1）「常见开源许可证授权概述」部分应参考：https://choosealicense.com/licenses/ （2）需加入木兰协议  | [立即修订](./第四部分——启动自己的开源项目/开源许可证的应用.md)  |
