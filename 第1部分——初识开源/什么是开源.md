...
上面我们简单介绍了一下开源软件，那么什么是开源硬件呢？类比开源软件，你可能会误以为开源硬件是可以免费获得、自由修改并再分发的硬件。如果你这么想，你就大错特错了，毕竟硬件是有形的，是看得见摸得着的。我们先来简单看一下[开源硬件协会](https://www.oshwa.org)（Open Source Hardware Association）对开源硬件的描述：
